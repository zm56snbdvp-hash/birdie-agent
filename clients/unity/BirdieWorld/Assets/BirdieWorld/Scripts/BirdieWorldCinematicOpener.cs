...
namespace BirdieWorld
{
    public sealed class BirdieWorldCinematicOpener : MonoBehaviour
    {
        ...
        public void Build(Transform parent, System.Action onBoard)
        {
            ...
            MakeText(root.transform,"BIRDIE & BREAKFAST",42,new Vector2(.06f,.83f),new Vector2(.55f,.93f),new Color(.86f,.67f,.34f,1),TextAnchor.MiddleLeft);
            ...
            MakeText(root.transform,"DEINE REISE BEGINNT HIER.",52,new Vector2(.06f,.57f),new Vector2(.58f,.75f),new Color(.94f,.91f,.83f,1),TextAnchor.MiddleLeft);
            MakeText(root.transform,"Mit Leni durch tiefe Täler. Über steile Grate.\nHinauf zu einer Welt, die erst mit dir entsteht.",23,new Vector2(.06f,.43f),new Vector2(.56f,.57f),new Color(.78f,.76f,.69f,1),TextAnchor.UpperLeft);
            ...
            MakeText(root.transform,"BETA 01  ·  CHARACTER CREATION",14,new Vector2(.06f,.10f),new Vector2(.42f,.16f),new Color(.62f,.51f,.32f,1),TextAnchor.MiddleLeft);
